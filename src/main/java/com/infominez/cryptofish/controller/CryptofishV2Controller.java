    ...
    public BaseResponse uploadCryptofish(
        ...
        try {
            ...
            if (imageName == null || !imageName.contains(".")) {
                log.error("Invalid image filename or missing extension");
                return baseResponse.set(400, "Image extension is not correct");
            }

            String extension = imageName.substring(imageName.lastIndexOf(".")).toLowerCase();
            log.info("extension = {}", extension);

            log.info(IMAGE_BASE_URL + tokenNumber + extension);




            // =========================================
            // 1️⃣ Check if txnHash already cached
            // =========================================
            if (txnCache.containsKey(txnHash)) {
                ...
                // =========================================
                // 2️⃣ Fetch transaction receipt from Ethereum node
                // =========================================
            ...
            // =========================================
            // 3️⃣ Check if requested token is in transaction logs
            // =========================================
            ...
            // =========================================
            // 4️⃣ Create metadata JSON
            // =========================================
            Map<String, Object> jsonMap = new LinkedHashMap<>();
            jsonMap.put("image", IMAGE_BASE_URL + tokenNumber + extension);
...
//            log.info("Saved image at: {}", imagePath);
            ...
            Path imagePath = Paths.get(IMAGE_SAVE_DIR, tokenNumber + extension);
